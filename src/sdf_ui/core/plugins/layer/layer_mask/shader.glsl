...
layout (rgba8, binding = 1) readonly uniform image2D tex0;
layout (rgba8, binding = 2) readonly uniform image2D tex1;
layout (rgba8, binding = 3) readonly uniform image2D mask;
